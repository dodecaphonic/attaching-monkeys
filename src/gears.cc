      ...
      char *argv[])
{
  ...
  // // g_signal_connect (win.gobj(), "delete_event",
  ...
  gtk_widget_set_gl_capability (GTK_WIDGET(canvas.gobj()),
				glconfig,
				NULL,
				TRUE,
				GDK_GL_RGBA_TYPE);

  // gtk_widget_add_events (GTK_WIDGET(canvas.gobj()),
  //       		 GDK_VISIBILITY_NOTIFY_MASK);

  // g_signal_connect_after (canvas.gobj(), "realize",
  //                         G_CALLBACK (init), NULL);
  // g_signal_connect (canvas.gobj(), "configure_event",
  //       	    G_CALLBACK (reshape), NULL);
  // g_signal_connect (canvas.gobj(), "expose_event",
  //       	    G_CALLBACK (draw), NULL);
  // g_signal_connect (canvas.gobj(), "map_event",
  //       	    G_CALLBACK (map), NULL);
  // g_signal_connect (canvas.gobj(), "unmap_event",
  //       	    G_CALLBACK (unmap), NULL);
  // g_signal_connect (canvas.gobj(), "visibility_notify_event",
